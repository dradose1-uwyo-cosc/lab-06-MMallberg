...
print(f"{lowest_key} is the least ocurring character.")
print(f"{highest_key} is the most occurring character.")
...
percentages={}
for key,value in counts.items():
    percentages[key]= value/2500*100
